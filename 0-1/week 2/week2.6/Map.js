...
// 2. Defining a function and passing it in map
function transform(i) {
  return i * 2;
}
const ans = arr.map(transform); //Important line   syntax arr.map(function())
console.log(ans);

//3.  Using map (Defining a function inside map)
